...
public abstract class Hilt_VehicleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VehicleFragment() {
    super();
  }

  Hilt_VehicleFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VehicleFragment_GeneratedInjector) this.generatedComponent()).injectVehicleFragment(UnsafeCasts.<VehicleFragment>unsafeCast(this));
    }
  }
