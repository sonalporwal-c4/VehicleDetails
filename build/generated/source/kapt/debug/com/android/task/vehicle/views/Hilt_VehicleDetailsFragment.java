...
public abstract class Hilt_VehicleDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VehicleDetailsFragment() {
    super();
  }

  Hilt_VehicleDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VehicleDetailsFragment_GeneratedInjector) this.generatedComponent()).injectVehicleDetailsFragment(UnsafeCasts.<VehicleDetailsFragment>unsafeCast(this));
    }
  }
